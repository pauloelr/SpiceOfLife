...
public class ModConfig implements IPackable, IPacketProcessor
{
	...
	public static int FOOD_CONTAINERS_LUNCH_BOX_SIZE = ModConfig.FOOD_CONTAINERS_LUNCH_BOX_SIZE_DEFAULT;
	public static int FOOD_CONTAINERS_LUNCH_BAG_SIZE = ModConfig.FOOD_CONTAINERS_LUNCH_BAG_SIZE_DEFAULT;
	private static final String FOOD_CONTAINERS_MAX_STACKSIZE_NAME = "food.containers.max.stacksize";
	private static final String FOOD_CONTAINERS_LUNCH_BOX_SIZE_NAME = "food.containers.lunch_box.size";
	private static final String FOOD_CONTAINERS_LUNCH_BAG_SIZE_NAME = "food.containers.lunch_bag.size";
	private static final int FOOD_CONTAINERS_MAX_STACKSIZE_DEFAULT = 2;
	private static final int FOOD_CONTAINERS_LUNCH_BOX_SIZE_DEFAULT = 6;
	private static final int FOOD_CONTAINERS_LUNCH_BAG_SIZE_DEFAULT = 3;
	private static final String FOOD_CONTAINERS_MAX_STACKSIZE_COMMENT =
		"The maximum stacksize per slot in a food container";
	private static final String FOOD_CONTAINERS_LUNCH_BOX_SIZE_COMMENT = "The number of slots on a Lunch Box";
	private static final String FOOD_CONTAINERS_LUNCH_BAG_SIZE_COMMENT = "The number of slots on a Lunch Bag";
	...
	public static void init(File file)
	{
		...
		FOOD_CONTAINERS_LUNCH_BOX_SIZE = config.get(CATEGORY_SERVER, FOOD_CONTAINERS_LUNCH_BOX_SIZE_NAME, FOOD_CONTAINERS_LUNCH_BOX_SIZE_DEFAULT, FOOD_CONTAINERS_LUNCH_BOX_SIZE_COMMENT).getInt(FOOD_CONTAINERS_LUNCH_BOX_SIZE_DEFAULT);
		FOOD_CONTAINERS_LUNCH_BAG_SIZE = config.get(CATEGORY_SERVER, FOOD_CONTAINERS_LUNCH_BAG_SIZE_NAME, FOOD_CONTAINERS_LUNCH_BAG_SIZE_DEFAULT, FOOD_CONTAINERS_LUNCH_BAG_SIZE_COMMENT).getInt(FOOD_CONTAINERS_LUNCH_BAG_SIZE_DEFAULT);
